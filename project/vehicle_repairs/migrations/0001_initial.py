# Generated by Django 4.1 on 2022-08-22 18:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicles_history', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(blank=True), size=None)),
                ('views_history', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(blank=True), size=None)),
                ('following', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(blank=True), size=None)),
